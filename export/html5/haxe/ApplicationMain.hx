...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SideScrollingShooter", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SideScrollingShooter", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "118";
		app.meta["company"] = "Jonathan So";
		app.meta["file"] = "SideScrollingShooter";
		app.meta["name"] = "VanishVector";
